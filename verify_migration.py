...
# postgresql://postgres:password@host:port/postgres -> talentflow
conn_params = {
...
try:
    # Connect to talentflow database
    ...
    if results2:
        print(f"✓ career_readiness_history table EXISTS")
    else:
    ...
    conn.close()
    print("\n" + "=" * 80)
    print("Migration Status: SUCCESS - All components found!")
    print("=" * 80)
