...
function OnboardingContent() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gradient-to-br from-[#fff9f5] via-[#fff8f0] to-[#ffe8d6]">
      ...
      {/* 35/65 Layout Grid - Responsive */}
      <div className="flex-1 flex flex-col md:grid md:grid-cols-[35%_65%] gap-6 overflow-hidden p-4 md:p-6">
        {/* Left Panel - Step Guide (35% on desktop, full width on mobile) */}
        <div className="bg-white/60 backdrop-blur-sm rounded-2xl border border-orange-100/50 shadow-sm overflow-hidden h-auto md:h-full">
          <div className="p-4 md:p-6 space-y-3 h-full flex flex-col overflow-y-auto md:overflow-y-visible">
        ...
        {/* Right Panel - Chat Interface (65% on desktop, full width on mobile) */}
        <div className="flex flex-col bg-white/60 backdrop-blur-sm rounded-2xl border border-orange-100/50 shadow-sm overflow-hidden h-auto md:h-full">
          {/* Messages Area */}
          <div
            ref={scrollRef}
      ...
      <div className="px-6 py-6 bg-white/80 backdrop-blur-sm border-t border-orange-100/30 shadow-[0_-4px_16px_rgba(255,152,0,0.08)]">
        <div className="max-w-5xl mx-auto relative flex flex-col gap-3">
          ...
          <div className="flex items-center gap-2 md:gap-3 bg-white border-2 border-orange-200 focus-within:border-orange-400 focus-within:ring-4 focus-within:ring-orange-100 transition-all px-2 py-2 rounded-2xl shadow-sm m-4 md:m-6">
            <input
              type="text"
              value={input}
              ...
              className="flex-1 bg-transparent px-2 md:px-4 py-2 text-slate-700 placeholder:text-slate-500 focus:outline-none text-sm font-medium"
            />
            <button
