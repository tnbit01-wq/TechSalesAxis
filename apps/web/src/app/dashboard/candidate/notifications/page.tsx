    ...
    <div className="max-w-6xl mx-auto px-4 py-6 space-y-6 pb-20">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm mt-2">Stay updated with your latest alerts and events.</p>
        </div>
              ...
              >
                {notif.type === "ASSESSMENT_REMINDER" ? (
                  ...
                  <Bell className={`h-5 w-5 ${
                    notif.type === "INTERVIEW_PROPOSED" ? "text-amber-500" : "text-blue-600"
                  }`} />
                )}
              </div>
              ...
              <div className="flex items-center gap-1 flex-shrink-0">
                {notif.type === "INTERVIEW_PROPOSED" && !notif.is_read && (
                  <button 
                    ...
                    className="px-2 py-1.5 bg-amber-50 text-amber-600 rounded-lg text-[9px] font-bold hover:bg-amber-600 hover:text-white transition-colors whitespace-nowrap"
                  >
                    Respond
                  </button>
                )}
