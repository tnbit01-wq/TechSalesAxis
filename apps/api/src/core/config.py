...
ZEPTO_JOB_INVITE_TEMPLATE_ID = os.getenv("ZEPTO_JOB_INVITE_TEMPLATE_ID", "").strip()
ZEPTO_SHORTLIST_TEMPLATE_ID = os.getenv("ZEPTO_SHORTLIST_TEMPLATE_ID", "").strip()
ZEPTO_REJECTION_TEMPLATE_ID = os.getenv("ZEPTO_REJECTION_TEMPLATE_ID", "").strip()
ZEPTO_INTERVIEW_PROPOSED_TEMPLATE_ID = os.getenv("ZEPTO_INTERVIEW_PROPOSED_TEMPLATE_ID", "").strip()
ZEPTO_INTERVIEW_CONFIRMED_TEMPLATE_ID = os.getenv("ZEPTO_INTERVIEW_CONFIRMED_TEMPLATE_ID", "").strip()
