...
class CandidateProfile(Base):
    ...
    dominant_role = Column(Text)
    years_of_experience = Column(Integer)
    tech_years = Column(Integer)
    sales_years = Column(Integer)
    tech_sales_years = Column(Integer)
    total_relevant_years = Column(Integer)
    primary_industry_focus = Column(Text)
    primary_career_pattern = Column(Text)
    role_frequency = Column(JSONB)
    ...
    current_company_name = Column(Text)
    previous_companies = Column(ARRAY(Text))
    ...
    contract_preference = Column(String, default='fulltime')
    visa_sponsorship_needed = Column(Boolean, default=False)
    target_market_segment = Column(String, default='any')
    between_role_detail = Column(String, nullable=True)  # laid_off | contract_ended | resigned | other
    between_role_note = Column(Text, nullable=True)
